...
class Account < ApplicationRecord
 ...
 # GENIA OS - RESCUE MODE
  def plan_name; 'enterprise'; end
  def feature_enabled?(feature); true; end
  def custom_branding_enabled?; true; end
  def usage_limits; { agents: 999999, inboxes: 999999 }; end
  def validate_limit_keys; true; end
